...
const Hero = () => {
  return (
    <div class=' min-h-screen bg-black md:min-h-0  md:py-20 '>
      <div class='flex grid-cols-12 flex-col px-5 text-gray-100 md:mx-7 md:grid lg:mx-10'>
        ...
        />
        <section class='pt-20 pb-32 sm:ml-10 md:col-span-8 md:-mt-28 md:pl-36'>
          <p className='mb-0 text-left text-lg  md:text-3xl'>
