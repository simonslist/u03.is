...
const CTA = () => {
  return (
    <Widget id="nt5EzOXk" style={{ height: "100%" }} className="my-form" />
  );
};
...
const Consultation = () => {
  return (
    <div
      id="consultation"
      class="grid  grid-cols-12 bg-white py-36 px-5 lg:px-36"
    >
      <div class="col-span-12 ">
        <div class="mx-auto max-w-screen-md p-5">
          <div class="mb-16 text-center">
            <h2 class="text-3xl font-extrabold leading-normal tracking-tight text-gray-900 sm:text-4xl">
              Free Consultation
            </h2>
          </div>
            ...
            <div class="-mx-3 mb-6 flex flex-wrap">
              ...
              <div class="w-full px-3 md:w-1/2">
                <label
                  ...
                  for="grid-last-name"
                >
                  Which grade is your child currently in?This question is
                  required.
                </label>
                <input
