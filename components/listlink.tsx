...
const ListLink = ({ href, label }) => {
  return (
    <div className="not-prose relative group">
      ...
      <Link
        href={href}
        className="relative mx-0 flex content-between gap-0 rounded-lg  py-4 pl-5 leading-none group-hover:text-blue-900 dark:group-hover:text-primary dark:bg-neutral-900 bg-neutral-100 text-black"
      >
        {label}
      </Link>
    </div>
